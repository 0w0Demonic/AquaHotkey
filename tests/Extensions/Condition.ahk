...
class Condition {
    ...
    static Greater() {
        Array(1, 2, 3, 4).RetainIf(  Condition.Greater(2)  )
            .Join().AssertEquals("34")
    }

    static GreaterOrEqual() {
        Array(1, 2, 3, 4).RetainIf(  Condition.GreaterOrEqual(2)  )
            .Join().AssertEquals("234")
    }

    static Less() {
        Array(1, 2, 3, 4).RetainIf(  Condition.Less(3)  )
            .Join().AssertEquals("12")
    }

    static LessOrEqual() {
        Array(1, 2, 3, 4).RetainIf(  Condition.LessOrEqual(2)  )
            .Join().AssertEquals("12")
    }
    ...
    static InStr() {
        Array("Hello", "world!").RetainIf(  Condition.InStr("e")  )
