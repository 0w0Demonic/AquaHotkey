...
class AquaHotkey_Stream_Joins extends AquaHotkey {
    class Stream {
         ...
         * a single value, resulting in a 1-parameter {@link Stream}. By
         * default, this method returns a {@link DoubleStream} of "matching
         * pairs".
         * 
         * ```ahk
         ...
         * 
         * A *key selector* (used for `LHS` and `RHS`) can be either a 1-param
         * function that returns a key, or the name of a property that should
         * be treated as key.
         * 
         * ```ahk
         * KeySelector(Obj: Any) => Any
        ...
        /**
         * Combines every element from this stream and the `Other`. The result
         * is a Cartesian product, containing all possible combinations of
         * elements from both streams. If `Other` is not specified, this stream
         * merges with itself.
         * 
