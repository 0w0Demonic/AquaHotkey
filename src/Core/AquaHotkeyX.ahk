...
;@region Collections/
    ;@region Generic/
        ...
        #Include "%A_LineFile%\..\..\Collections\Generic\Set.ahk"
    ;@endregion
...
;@region Func/
   ...
   ;#Include "%A_LineFile%\..\..\Func\Transducer.ahk"
;@endregion
;@region Interfaces/
...
;@endregion
;@region System/
   ;#Include "%A_LineFile%\..\..\System\COM.ahk"
   ;#Include "%A_LineFile%\..\..\System\DLL.ahk"
;@endregion
;@region Time/
   ;#Include "%A_LineFile%\..\..\Time\Duration.ahk"
   ;#Include "%A_LineFile%\..\..\Time\Timer.ahk"
;@endregion
