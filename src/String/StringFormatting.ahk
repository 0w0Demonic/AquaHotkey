...
class AquaHotkey_StringFormatting extends AquaHotkey {
    class String {
        ...
        /**
         * Strips all whitespace from this string and then formats words into
         * lines with a maximum length of `n` characters.
         * 
        ...
        /**
         * Returns this string surrounded by double quotes (`"`).
         * 
         * @returns {String}
         * @example
         * "test".Quote() ; '"test"'
