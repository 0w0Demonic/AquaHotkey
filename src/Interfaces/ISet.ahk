 ...
 * {@link ISet}.
 */
class AquaHotkey_ISet_Serialization extends AquaHotkey {
    ...
    class ISet {
        ...
        /**
         * Reconstructs the set from binary. This method assumes that calling
         * the constructor with no arguments will properly construct an empty,
