 ...
 * {@link IMap}.
 */
class AquaHotkey_IMap_Serialization extends AquaHotkey {
    ...
    class IMap {
        ...
        /**
         * Reconstructs this map object from binary. This method assumes the
         * object can be properly constructed simply by calling the class
         * object with no parameters. For example: `M := MapClass()`.
         * 
