...
`Module_AquaHotkeyX.md` covers the AquaHotkeyX standard library — the
batteries-included companion that adds functional programming methods to built-in
types and introduces new types like Stream, Optional, TryOp, Collector, Comparator,
and more.
