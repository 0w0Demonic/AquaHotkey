...
An [IMap](../Interfaces/IMap.md) backed with a doubly-linked list to preserve
insertion order. Use `.Push(Values*)` to add elements in the back of the list.
Use `.Shove(Values*)` to add elements in the front of the list.
